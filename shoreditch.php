...
function shoreditch_civicrm_coreResourceList(&$items, $region) {
  if ($region == 'html-header') {
    ...
    CRM_Core_Resources::singleton()->addScriptFile('org.civicrm.shoreditch', 'js/add-missing-date-addons.js', 1002, 'html-header');
    CRM_Core_Resources::singleton()->addScriptFile('org.civicrm.shoreditch', 'js/main-menu.js', '1003', 'html-header');
  }
}
